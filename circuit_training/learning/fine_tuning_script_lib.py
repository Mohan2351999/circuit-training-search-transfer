...
def train(
  ...
  # print("Actor Net: ", actornet.summary())
  ...
  print("Saved Model Trigger started!", saved_model_dir)
  ...
  print("Saved Model Trigger finished!")
  ...
  print("Actor Net: ", grl_actor_net._shared_network._model._policy_location_head.summary())
  print("Value Net:", grl_actor_net._shared_network._model._value_head.summary())
